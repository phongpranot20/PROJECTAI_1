...
export const AVAILABLE_MODELS = [
  'gemini-2.0-flash-lite-001', // เบาและประหยัดโควต้าที่สุด - ตัวแรก
  'gemini-2.0-flash',          // ตัวรอง
  'gemini-flash-lite-latest',  // ตัวสำรอง
  'gemini-3-flash-preview',    // ตัวมาตรฐาน
  'gemini-3.1-pro-preview'     // ตัวสุดท้าย - ฉลาดที่สุด
];
...
function handleGeminiError(error: any) {
  ...
  const lastUpdate = "4 เม.ย. 2569 - 22:31 (UTC)"; // เวลาอัปเดตล่าสุด
