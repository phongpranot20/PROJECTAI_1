// Last Update: 5 Apr 2026 - 09:35 (UTC) - Fixed 404 Error
...
export const AVAILABLE_MODELS = [
  'gemini-1.5-flash',          // ตัวมาตรฐาน: เสถียรที่สุด
  'gemini-1.5-flash-latest',   // ตัวมาตรฐานล่าสุด
  'gemini-2.0-flash-lite-001', // ตัวใหม่: เบาและเร็ว
  'gemini-2.0-flash',          // ตัวใหม่: ฉลาดและเร็ว
  'gemini-1.5-pro',            // ตัวท็อป: ฉลาดที่สุด
  'gemini-flash-lite-latest'   // ตัวสำรองสุดท้าย
];
